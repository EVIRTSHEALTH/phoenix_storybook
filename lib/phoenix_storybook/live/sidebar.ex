defmodule PhoenixStorybook.Sidebar do
  ...
  def render(assigns) do
    ...
    <section
      ...
      class="psb psb:text-gray-600 psb:dark:text-slate-400 psb:lg:block psb:fixed psb:z-20 psb:lg:z-auto psb:w-80 psb:lg:w-60 psb:text-base psb:lg:text-sm psb:h-screen psb:flex psb:flex-col psb:flex-grow psb:bg-slate-50 psb:dark:bg-zinc-800 psb:lg:pt-20 psb:pb-32 psb:px-4 psb:overflow-y-auto"
    >
      ...
      <div class="psb psb:hidden psb:lg:block psb:fixed psb:bottom-3 psb:left-0 psb:w-60 psb:text-md psb:text-center psb:text-slate-400 psb:hover:text-indigo-600 psb:hover:font-bold">
        <%= link to: "https://github.com/EVIRTSHEALTH/phoenix_storybook", target: "_blank", class: "psb" do %>
